...
import { addDoc, collection, doc, getDoc, getDocs, getFirestore, limit, orderBy, query, writeBatch } from "firebase/firestore";

const firebaseConfig = {
    apiKey: "AIzaSyDBgBCPqtGcyK7fGPsmq2TE8KFkHdoocqk",
    authDomain: "ultimaentregareact.firebaseapp.com",
    projectId: "ultimaentregareact",
    storageBucket: "ultimaentregareact.appspot.com",
    messagingSenderId: "167114610184",
    appId: "1:167114610184:web:21177cdaf29aa79bac63bd",
};

const app = initializeApp(firebaseConfig);
const db = getFirestore(app);

export async function exportDataBatch() {
...
export function obtenerListadoDeProductos() {
